/**
 * اسکریپت اینلاین PostHog – در تمام صفحات قبل از </body> لود می‌شود.
 * از env: NEXT_PUBLIC_POSTHOG_KEY و NEXT_PUBLIC_POSTHOG_HOST
 */
